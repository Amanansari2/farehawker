...
class S {
  ...
  String get GroupBookingTitle {
    return Intl.message(
      'Group Booking',
      name: 'groupBookingTite',
      desc: '',
      args: [],
    );
  }
