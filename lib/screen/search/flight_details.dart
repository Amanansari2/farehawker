...
//                                         ),
//                                         Text(
//                                           "${widget.flight.stops} Stop  | ${formatJourneyTime(widget.flight.journeyTime.toString())} mins | ${widget.flight.cabinClass}",
//                                           style: kTextStyle.copyWith(color: kSubTitleColor),
//                                         ),
//                                       ],
//                                     ),
...
class _FlightDetailsState extends State<FlightDetails> {
  ...
  // ------------------ FLIGHT DETAIL CARD ------------------
  Widget _buildFlightDetailCard(SearchFlightProvider provider) {
    return Container(
      decoration: const BoxDecoration(
        color: kWhite,
        borderRadius: BorderRadius.only(
  ...
  Widget _buildRouteHeader(SearchFlightProvider provider) {
    return Container(
      width: context.width(),
      padding: const EdgeInsets.all(20.0),
      decoration: BoxDecoration(
